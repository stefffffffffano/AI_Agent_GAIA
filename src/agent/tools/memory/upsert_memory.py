...
upsert_memory = Tool(
    ...
    description="""Upsert a memory in the database.
        ...
        remember details (be specific) of the conversation you are having and of what is returned 
        by other tools. Also your reasoning process is important to remember.
